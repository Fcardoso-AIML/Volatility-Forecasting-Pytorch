...
def load_all_results():
    ...
    patterns = [
        os.path.join(results_dir, 'complete_pipeline_*.json'),
        os.path.join(results_dir, 'lstm_training_*.json')
    ]
    
    result_files = []
    for p in patterns:
        result_files.extend(glob.glob(p))
    ...
    for file_path in result_files:
        try:
            ...
            # Some files may not have the same structure
